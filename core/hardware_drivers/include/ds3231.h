...
enum rtc_register {
  DS3231_DATETIME_REG = 0x00,
  DS3231_ALARM1_REG = 0x07,
  DS3231_ALARM2_REG = 0x0B,
  DS3231_CONTROL_REG = 0x0E,
  DS3231_STATUS_REG = 0x0F,
  DS3231_AGING_OFFSET_REG = 0x10,
  DS3231_TEMPERATURE_REG = 0x11
};
 ...
 *
 * This library: assumes century is 2000, hour is alway entered in 24-h format,
 * day 1 is Monday, day 7 is Sunday DS years are 1900 to 2099. Here I assume
 * century is 2000
 */
typedef struct {
 ...
 */
void ds3231_init(i2c_inst_t *i2c_port, uint8_t i2c_address, ds3231_rtc_t *rtc);
 ...
 */
void ds3231_isoformat(char *buf,
    uint8_t buf_size,
 ...
 * \param dt The datetime to be converted
 */
void ds3231_str_date(char *buf, uint8_t buf_size, const ds3231_datetime_t *dt);
 ...
 * \param dt The datetime to be converted
 */
void ds3231_str_time(char *buf, uint8_t buf_size, const ds3231_datetime_t *dt);
 ...
 * \param dt The datetime to be converted
 */
void ds3231_ctime(char *buf, uint8_t buf_size, const ds3231_datetime_t *dt);
