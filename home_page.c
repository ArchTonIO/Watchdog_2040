...
{
  ssd1306_draw_bitmap(drivers->oled_screen, 0, 0, get_battery_level_bitmap(), TOP_BAR_BITMAPS_W, TOP_BAR_BITMAPS_H, false);
  ssd1306_draw_bitmap(drivers->oled_screen, TOP_BAR_BITMAPS_W, 0, get_sd_status_bitmap(), TOP_BAR_BITMAPS_W, TOP_BAR_BITMAPS_H, false);
  ssd1306_draw_bitmap(drivers->oled_screen, TOP_BAR_BITMAPS_W * 2, 0, get_sx1278_status_bitmap(), TOP_BAR_BITMAPS_W, TOP_BAR_BITMAPS_H, false);
