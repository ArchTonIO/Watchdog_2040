...
struct path
{
  ...
  char *full_name; /**< The full name of this file or directory, including extension (for files) */
  char *name;      /**< The name of this file or directory, excluding the extension */
