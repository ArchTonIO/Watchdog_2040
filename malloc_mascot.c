...
void malloc_greets_you()
{
  ...
  ssd1306_print_gradually(drivers->oled_screen, "mi occupo di", 4, 2, 0);
  ssd1306_print_gradually(drivers->oled_screen, "tutto qui dentro.", 4, 3, 0);
  press_to_continue();
  clear_text_area();
}
...
void malloc_explains_you_joystick()
{
  ...
  ssd1306_print_gradually(drivers->oled_screen, "Usa il joystick", 4, 0, 0);
  ssd1306_print_gradually(drivers->oled_screen, "per navigare in", 4, 1, 0);
  ssd1306_print_gradually(drivers->oled_screen, "tutte le ", 4, 2, 0);
  ssd1306_print_gradually(drivers->oled_screen, "direzioni e", 4, 3, 0);
  ssd1306_print_gradually(drivers->oled_screen, "premilo per", 4, 4, 0);
  ssd1306_print_gradually(drivers->oled_screen, "selezionare.", 4, 5, 0);
  press_to_continue();
  clear_text_area();
}
...
void malloc_explains_you_menu()
{
  ...
  ssd1306_print_gradually(drivers->oled_screen, "vai a destra per", 4, 5, 0);
...
void malloc_asks_your_name() // TODO: fix this
{
  ...
  while (1)
  {
    ...
    ssd1306_print_gradually(drivers->oled_screen, "i 16 caratteri", 4, 3, 0);
  ...
  ssd1306_draw_bitmap(drivers->oled_screen, 0, 19, malloc_saying_hi, 26, 28, 0);
  ssd1306_print_gradually(drivers->oled_screen, "Ciao", 4, 0, 0);
  ssd1306_print_gradually(drivers->oled_screen, malloc_memories_inst->username, 4, 1, 0);
  ssd1306_print_gradually(drivers->oled_screen, "!", strlen(malloc_memories_inst->username) + 1, 1, 0);
...
void malloc_explains_you_home_screen()
{
  ...
  ssd1306_print_gradually(drivers->oled_screen, "home screen", 4, 3, 0);
  press_to_continue();
  clear_text_area();
  ssd1306_draw_bitmap(drivers->oled_screen, 0, 19, malloc_with_glasses, 26, 28, 0);
  ...
  ssd1306_print_gradually(drivers->oled_screen, "di carica della", 4, 5, 0);
  ...
  ssd1306_print_gradually(drivers->oled_screen, "premendo il", 4, 5, 0);
  ssd1306_print_gradually(drivers->oled_screen, "joystick", 4, 6, 0);
  press_to_continue();
  clear_text_area_reduced();
}
...
void malloc_generates_ulcp_address()
{
  ...
  press_to_continue();
  clear_text_area();
  ssd1306_print_gradually(drivers->oled_screen, "e l'ho inventato", 4, 0, 0);
  ssd1306_print_gradually(drivers->oled_screen, "ieri mentre", 4, 1, 0);
  ssd1306_print_gradually(drivers->oled_screen, "facevo colazione:", 4, 2, 0);
  ssd1306_print_gradually(drivers->oled_screen, "U(ncomplicated)", 4, 3, 0);
